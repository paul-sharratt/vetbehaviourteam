// Contact Form - Updated December 16, 2025
function noop() { }
function run(fn) {
    return fn();
}
...
// (157:6) {#each social as { label, link }}
function create_each_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*social*/ 2 && t0_value !== (t0_value = /*label*/ ctx[11] + "")) set_data(t0, t0_value);
			if (dirty & /*social*/ 2 && t2_value !== (t2_value = /*link*/ ctx[12].label + "")) set_data(t2, t2_value);

			if (dirty & /*social*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[12].url)) {
...
function create_else_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*inputs*/ 1 && input_name_value !== (input_name_value = /*input*/ ctx[8].label)) {
...
function create_if_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*inputs*/ 1 && textarea_name_value !== (textarea_name_value = /*input*/ ctx[8].label)) {
				attr(textarea, "name", textarea_name_value);
			}

			if (dirty & /*inputs*/ 1 && textarea_placeholder_value !== (textarea_placeholder_value = /*input*/ ctx[8].placeholder)) {
...
// (174:4) {#each inputs as input, i}
function create_each_block(ctx) {
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*input*/ ctx[8].type === "textarea") return create_if_block_2;
...
function create_fragment(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (!/*showSuccess*/ ctx[4]) return create_if_block_1;
		return create_else_block;
	}

	let current_block_type = select_block_type_1(ctx);
	let if_block0 = current_block_type(ctx);
	let if_block1 = /*showFail*/ ctx[5] && create_if_block();
