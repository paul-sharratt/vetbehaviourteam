...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div3, "id", "section-9c7b13f4-e5cc-4fb4-aac7-88d256741321");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "class", "component");
			attr(div3, "class", "section");
			attr(div3, "id", "section-0c9faedd-d75f-44ff-af31-14433aafe8d8");
		},
		m(target, anchor) {
			insert_hydration(target, div3, anchor);
			append_hydration(div3, div2);
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "id", "section-5670d823-1cf2-44a9-88fd-0443996da5a8");
		},
		m(target, anchor) {
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "class", "component");
			attr(div3, "class", "section");
			attr(div3, "id", "section-9d85c80d-92bb-4351-8169-330d31da9f49");
		},
		m(target, anchor) {
			insert_hydration(target, div3, anchor);
			append_hydration(div3, div2);
...
function create_fragment$6(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div0, "class", "component");
			attr(div1, "class", "section");
			attr(div1, "id", "section-416d5e4a-8533-4ddf-a493-2889393d8812");
		},
		m(target, anchor) {
			insert_hydration(target, div1, anchor);
			append_hydration(div1, div0);
...
function create_fragment$7(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div4, "id", "section-6a280a74-1598-48ba-bf47-bb7bf8f547e3");
		},
		m(target, anchor) {
...
function create_fragment$8(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				title: "Vet Behaviour Team",
				description: "Kindness + Science. The best of both worlds",
				superhead: "6th February 2024",
				heading: "Feline Enrichment",
				image: {
					"alt": "",
					"src": "https://cecahqcvnivcvvvhsdfd.supabase.co/storage/v1/object/public/images/5cfeba61-0502-41db-b62b-2bdd3a76f0b6/1707198005066pexels-arina-krasnikova-7725972.jpg",
					"url": "https://cecahqcvnivcvvvhsdfd.supabase.co/storage/v1/object/public/images/5cfeba61-0502-41db-b62b-2bdd3a76f0b6/1707198005066pexels-arina-krasnikova-7725972.jpg",
					"size": 426
				}
			}
		});
	...
	component_4 = new Component$5({
			props: {
				...
				description: "Kindness + Science. The best of both worlds",
				content: {
					"html": "<p>We’ve talked a lot about enrichment for dogs, but what about our feline friends?! Cats enjoy all the same benefits of having an enriched environment as dogs. </p>\n<h3 id=\"foodpuzzles\">Food puzzles</h3>\n<p>Cats are natural hunters and love to play with their food, which you know if you’ve seen a cat encounter one of our horrible Sydney cockroaches in summer! Food puzzles come in all shapes and sizes, and more and more are released all the time. This means you can select a puzzle that taps into your cat's preferences. Wobblers allow your cat to bat at the toy to get the food, while some feeders require your cat to reach into small pockets or containers and use their paws to pull out the food. </p>\n<h3 id=\"threedimensionalspace\">Three dimensional space</h3>\n<p>Cats are uniquely situated as both a predator to smaller animals and prey to larger animals. Because of this vulnerability, they thrive on having lots of little hiding places or escape routes. </p>\n<p>Vertical spaces and platforms are fantastic rest spots for this reason. Cats often feel safer higher up where they can survey their kingdom for any potential threats. It also gives them a good vantage point to find prey and pounce. </p>\n<p>Little boxes and cubbies provide protection and allow cats to keep an eye on what’s happening whilst staying protected on all sides. </p>\n<h3 id=\"scratchposts\">Scratch posts</h3>\n<p>Scratching has a number of benefits from claiming territory with scent and visual markers, to grooming their claws and keeping them clean and sharp. \nNot all scratching posts are created equal, and cat’s have very specific preferences for textures and angles. So if your cat isn’t engaging with the rope covered pole, maybe try a horizontal cardboard scratcher instead. </p>\n<h3 id=\"visualstimulation\">Visual stimulation</h3>\n<p>Cats love to watch the world around them. Having a warm bed in a sunny window where they can watch the birds go by is bliss. This type of visual stimulation plays upon a cat’s prey drive. You may notice your cat run from one window to another to keep track of an animal that has caught their attention. </p>\n<h3 id=\"toys\">Toys</h3>\n<p>Another activity that utilises a cat’s prey drive is playing with toys. Just like they play with their food, cats love to play with little toys. There are motorised toys that move on their own, wand toys that let you join in the game too and little fluffy toys. Whatever your cat likes to play with it is important to swap the toys that are available regularly to make sure they stay interesting and fun.</p>",
					"markdown": "We’ve talked a lot about enrichment for dogs, but what about our feline friends?! Cats enjoy all the same benefits of having an enriched environment as dogs. \n\n###Food puzzles\n\nCats are natural hunters and love to play with their food, which you know if you’ve seen a cat encounter one of our horrible Sydney cockroaches in summer! Food puzzles come in all shapes and sizes, and more and more are released all the time. This means you can select a puzzle that taps into your cat's preferences. Wobblers allow your cat to bat at the toy to get the food, while some feeders require your cat to reach into small pockets or containers and use their paws to pull out the food. \n\n###Three dimensional space\nCats are uniquely situated as both a predator to smaller animals and prey to larger animals. Because of this vulnerability, they thrive on having lots of little hiding places or escape routes. \n\nVertical spaces and platforms are fantastic rest spots for this reason. Cats often feel safer higher up where they can survey their kingdom for any potential threats. It also gives them a good vantage point to find prey and pounce. \n\nLittle boxes and cubbies provide protection and allow cats to keep an eye on what’s happening whilst staying protected on all sides. \n\n###Scratch posts\n\nScratching has a number of benefits from claiming territory with scent and visual markers, to grooming their claws and keeping them clean and sharp. \nNot all scratching posts are created equal, and cat’s have very specific preferences for textures and angles. So if your cat isn’t engaging with the rope covered pole, maybe try a horizontal cardboard scratcher instead. \n\n###Visual stimulation\n\nCats love to watch the world around them. Having a warm bed in a sunny window where they can watch the birds go by is bliss. This type of visual stimulation plays upon a cat’s prey drive. You may notice your cat run from one window to another to keep track of an animal that has caught their attention. \n\n###Toys\n\nAnother activity that utilises a cat’s prey drive is playing with toys. Just like they play with their food, cats love to play with little toys. There are motorised toys that move on their own, wand toys that let you join in the game too and little fluffy toys. Whatever your cat likes to play with it is important to swap the toys that are available regularly to make sure they stay interesting and fun.\n\n\n"
				}
			}
		});
