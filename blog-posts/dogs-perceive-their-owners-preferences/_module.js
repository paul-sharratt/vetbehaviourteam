...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-1nu6zvy', document.head);
			...
			script3 = claim_element(head_nodes, "SCRIPT", { src: true });
			...
			t2 = claim_text(script4_nodes, "window.onload = function() {\n  const urlObj = new URL(window.location.href);\n  const searchParams = urlObj.searchParams;\n  \n    GReminders.BookingWidget.initialize(\n        //create an event type and put the link below: https://app.greminders.com/event-types\n        //or use with Routing Forms: https://app.greminders.com/routing-forms\n        'https://app.greminders.com/c/paulsharratt/test',\n        \n        //here are all the options\n        {\n            // you can trigger this based on a button or some other action\n            anchorEl: document.getElementById('schedule_button'),  //you can omit this line completely if you like and just use: GReminders.BookingWidget.open(); in your code \n        \n            fields: {\n                first_name: '',            // you can prepopulate the fields here if you already have this information\n                last_name: '',\n                phone: '',\n                email: '',\n                auto_submit: false,       \n                remember_me: true,\n                utm_source: searchParams.get('utm_source') || '',     \n                utm_medium: searchParams.get('utm_medium') || '',     \n                utm_campaign: searchParams.get('utm_campaign') || '', \n                utm_content: searchParams.get('utm_content') || '',   \n                utm_term: searchParams.get('utm_term') || '' \n            },            \n            styles: {\n                zIndex: 100        \n            }            \n        }\n    );\n    GReminders.BookingWidget.onSuccess(function(event_id, form_data) {\n        //we automatically close the widget on successful booking, you can continue your flow here\n        GReminders.BookingWidget.close();\n        alert('Success! ' + event_id + ' Customer Form Data: ' + JSON.stringify(form_data));\n    });\n    GReminders.BookingWidget.onError(function(message) {\n        //if we encounter a booking error you can trigger a different error or retry\n        GReminders.BookingWidget.close();\n        alert('Error! ' + message);\n    });\n        \n    // or trigger the widget using this: \n    // GReminders.BookingWidget.open();\n};\n");
		...
		h() {
			...
			if (!src_url_equal(script3.src, script3_src_value = "https://app.greminders.com/widgets/booking.js")) attr(script3, "src", script3_src_value);
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div3, "id", "section-d5c8481f-dcf3-463f-9d78-2c8a05f1d045");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "class", "component");
			attr(div3, "class", "section");
			attr(div3, "id", "section-bcd49a86-d42c-4f8e-8460-735b0c921cf4");
		},
		m(target, anchor) {
			insert_hydration(target, div3, anchor);
			append_hydration(div3, div2);
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "id", "section-305835bb-8937-4e53-a321-70e15473f082");
		},
		m(target, anchor) {
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "class", "component");
			attr(div3, "class", "section");
			attr(div3, "id", "section-912b2439-1d39-41ff-a29b-4245fd4a9174");
		},
		m(target, anchor) {
			insert_hydration(target, div3, anchor);
			append_hydration(div3, div2);
...
function create_fragment$6(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div0, "class", "component");
			attr(div1, "class", "section");
			attr(div1, "id", "section-3824c5c2-43d9-4652-8492-ec68aed48eb5");
		},
		m(target, anchor) {
			insert_hydration(target, div1, anchor);
			append_hydration(div1, div0);
...
function create_fragment$7(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div4, "id", "section-f9772772-2f81-4d98-befd-0cb81fbbe802");
		},
		m(target, anchor) {
...
function create_fragment$8(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				title: "Vet Behaviour Team",
				description: "Kindness + Science. The best of both worlds",
				superhead: "19th June 2023",
				heading: "Dogs perceive their owners' preferences (but do their own thing anyway)",
				image: {
					"alt": "",
					"url": "https://cecahqcvnivcvvvhsdfd.supabase.co/storage/v1/object/public/images/5cfeba61-0502-41db-b62b-2bdd3a76f0b6/11427572037643800839.jpg1687169618858"
				}
			}
		});
	...
	component_4 = new Component$5({
			props: {
				...
				description: "Kindness + Science. The best of both worlds",
				content: {
					"html": "<p>The age at which human infants can understand their parents is intensely studied by scientists, with research showing that 18-month-old babies are able to discern an adult’s preferences when offered two different types of foods. But do dogs have the same ability? <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://www.sciencefocus.com/news/dogs-perceive-their-owners-preferences-but-do-their-own-thing-anyway/\">Researchers at Eötvös Loránd University decided to find out</a>.</p>",
					"markdown": "The age at which human infants can understand their parents is intensely studied by scientists, with research showing that 18-month-old babies are able to discern an adult’s preferences when offered two different types of foods. But do dogs have the same ability? [Researchers at Eötvös Loránd University decided to find out](<https://www.sciencefocus.com/news/dogs-perceive-their-owners-preferences-but-do-their-own-thing-anyway/>).\n\n"
				}
			}
		});
