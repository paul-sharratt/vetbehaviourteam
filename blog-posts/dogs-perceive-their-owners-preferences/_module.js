...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-1nn68vq', document.head);
			...
			script4 = claim_element(head_nodes, "SCRIPT", { src: true });
		...
		h() {
			...
			if (!src_url_equal(script4.src, script4_src_value = "https://app.greminders.com/widgets/booking.js")) attr(script4, "src", script4_src_value);
			attr(script5, "type", "text/javascript");
		},
		m(target, anchor) {
